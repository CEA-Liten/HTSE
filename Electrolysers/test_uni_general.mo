...
model test_uni_general

  //replaceable package Medium_MoistH2 = HTSE.Media.Predefined.Mixture.Gas.IdealGasMixture_H2O_H2_N2;

 replaceable package Medium_MoistH2 = CEA_Energy_Process_library.Media.Predefined.Mixture.Diphasic.MoistGas.MoistHydrogen.SRKMoistH2_L1;
...
HTSE.Electrolysers.SOEC.models.electrolyzer_module electrolyzer_module(redeclare package Medium_MoistH2 = Medium_MoistH2, redeclare package Medium_Air = Medium_Air)
